...
const (
	statusURL = "/status-token-list.json"
)
...
var statusTokenListEmpty = TokenList{
	Name:             "Status Token List",
	Timestamp:        "2025-09-01T13:00:00.000Z",
	FetchedTimestamp: fetchedStatusTokenListEmpty.Fetched.Format(time.RFC3339),
	Source:           "https://example.com/status-token-list.json",
	Version: Version{
		Major: 0,
		Minor: 1,
		Patch: 0,
...
var statusTokenListInvalidTokens = TokenList{
	Name:             "Status Token List",
	Timestamp:        "2025-09-01T13:00:00.000Z",
	FetchedTimestamp: fetchedStatusTokenList.Fetched.Format(time.RFC3339),
	Source:           "https://example.com/status-token-list.json",
	Version: Version{
		Major: 0,
		Minor: 1,
