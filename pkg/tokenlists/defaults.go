...
// DefaultChains provides the default chains that are supported by the token lists.
var DefaultChains = []common.ChainID{
...
// defaultCommunityTokenStore provides a default community token store implementation.
type defaultCommunityTokenStore struct {
	communityTokens []Token
}

func (s *defaultCommunityTokenStore) GetAll() ([]Token, error) {
	return s.communityTokens, nil
}

func NewDefaultCommunityTokenStore() CommunityTokenStore {
	return &defaultCommunityTokenStore{}
}
...
func DefaultConfig() *Config {
	return &Config{
		...
		CommunityTokenStore:           NewDefaultCommunityTokenStore(),
