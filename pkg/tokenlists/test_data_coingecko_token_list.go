...
var fetchedCoingeckoTokenList = fetchedTokenList{
	tokenList: tokenList{
...
var fetchedCoingeckoTokenListInvalidTokens = fetchedTokenList{
	tokenList: tokenList{
		SourceURL: "https://example.com/coingecko-token-list.json",
	},
...
var coingeckoTokenList = TokenList{
	Source: "https://example.com/coingecko-token-list.json",
	Tokens: []*Token{
		{
			ChainID: 1,
...
var coingeckoTokenListInvalidTokens = TokenList{
	Source: "https://example.com/coingecko-token-list.json",
	Tokens: []*Token{
		{
			ChainID: 10,
