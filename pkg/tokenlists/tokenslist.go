...
func getNativeToken(chainID uint64) *Token {
	crossChainID := common.EthereumNativeCrossChainID
	symbol := common.EthereumNativeSymbol
	name := common.EthereumNativeName
	logoURI := "https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/ethereum/assets/0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2/logo.png"
	if chainID == common.BSCMainnet || chainID == common.BSCTestnet {
		crossChainID = common.BinanceSmartChainNativeCrossChainID
		symbol = common.BinanceSmartChainNativeSymbol
		name = common.BinanceSmartChainNativeName
