...
var (
	cachetestDir, _   = filepath.Abs(filepath.Join("testdata", "extkeystore"))
	cachetestAccounts = []accounts.Account{
		{
			Address: common.HexToAddress("f33Cf2D0309Dc4E8518d4DF7BF94fd64D0cae9bB"),
			URL:     accounts.URL{Scheme: KeyStoreScheme, Path: filepath.Join(cachetestDir, "UTC--2025-11-14T16-35-58.315139000Z--f33cf2d0309dc4e8518d4df7bf94fd64d0cae9bb--ext")},
		},
		{
			Address: common.HexToAddress("3e93445e93ed04baa3e84e4eca16de77c80051e6"),
			URL:     accounts.URL{Scheme: KeyStoreScheme, Path: filepath.Join(cachetestDir, "aaa")},
		},
		{
			Address: common.HexToAddress("68b10ebd7309fac42e3e1f83e7d4d725cd6b579c"),
...
func TestCacheFind(t *testing.T) {
	...
	tests := []struct {
		...
		// no match error
		{Query: nomatchAccount, WantError: keystore.ErrNoMatch},
		{Query: accounts.Account{URL: nomatchAccount.URL}, WantError: keystore.ErrNoMatch},
		{Query: accounts.Account{URL: accounts.URL{Scheme: KeyStoreScheme, Path: filepath.Base(nomatchAccount.URL.Path)}}, WantError: keystore.ErrNoMatch},
		{Query: accounts.Account{Address: nomatchAccount.Address}, WantError: keystore.ErrNoMatch},
	}
