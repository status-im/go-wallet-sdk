...
func getL1ChainSuggestions(ctx context.Context, gasClient GasClient, params ChainParameters, config SuggestionsConfig) (*FeeSuggestions, error) {
	txSuggestions, err := getL1TxSuggestions(ctx, gasClient, params, config, nil)
	if err != nil {
...
func getL1TxSuggestions(ctx context.Context, gasClient GasClient, params ChainParameters, config SuggestionsConfig, callMsg *ethereum.CallMsg) (*TxSuggestions, error) {
	ret := &TxSuggestions{
