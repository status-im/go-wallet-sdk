...
func isEIP1559Compatible(fh *ethclient.FeeHistory, chainID uint64) bool {
...
func (f *FeeManager) getFeeHistory(ctx context.Context, chainID uint64, newestBlock *big.Int, rewardPercentiles []float64) (*ethclient.FeeHistory, error) {
