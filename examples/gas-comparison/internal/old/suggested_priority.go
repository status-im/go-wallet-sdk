...
func getEIP1559SuggestedFees(chainID uint64, feeHistory *ethclient.FeeHistory) (lowPriorityFee, avgPriorityFee, highPriorityFee, suggestedBaseFee *big.Int, err error) {
...
func calculateNetworkCongestion(feeHistory *ethclient.FeeHistory) float64 {
